            ...
            marginVertical: vh(20),
              ...
              <View style={styles.couponView}>
                <Image
                  ...
                  style={{width: vw(60), height: vh(60), borderRadius:50}}
                />
                ...
                <View style={styles.billValueView}>
                  <Text style={styles.billValueText}>{data.applicablefor}</Text>
                </View>
              </View>
...
export default LoyalityPointsCard;
