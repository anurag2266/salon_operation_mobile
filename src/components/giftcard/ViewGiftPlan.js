import {
  ...
  const ViewGiftPlan = ({navigation, route}) => {
  ...
  const [openDate, setOpenDate] = useState(false)
    ...
    const handleSubmit=async()=>{
      ...
      formData.append("totalServiceValue",membershipPlan.serviceValue)
      formData.append("discountType",membershipPlan.discountType)
      formData.append("fixedAmount",membershipPlan.fixedAmount)
      formData.append("discountcardPrice",membershipPlan.planPrice)
      formData.append("discountcardTotalPrice",membershipPlan.valueWithTax)
      formData.append("expirationType",myValidity.expiration)
      formData.append("expirationNoOfDays",myValidity.enterNo)
      formData.append("startFrom",setDatePicker)
      formData.append("endOn",setDatePicker2)
      ...
      formData.append("isAutoApply",appliedOn)
      formData.append("membersOnly",clubing)
      ...
      const {status,message,data}=await addDiscountCardbySalonId(formData);
      if(status==200){
        console.log("Here is Data",status,data)
      }
    }
    ...
    return (
      <View style={{flex: 1, backgroundColor: theme.color.white}}>
       ...
       <TouchableOpacity
          ...
          inputSearchStyle={styles.inputSearchStyle}
          placeholderStyle={styles.placeholderStyle}
          placeholder={'Gift Card Applicable On'}
          labelField="label"
          valueField="value"
          maxHeight={300}
          onChange={() => {
        ...
        />
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <TextInput
              ...
              placeholderStyle={styles.placeholderStyle}
              textErrorStyle={styles.textErrorStyle}
              label={'Card Value With Tax'}
              placeholder={'Card Value With Tax'}
              placeholderTextColor={theme.color.TextGrey}
              focusColor={theme.color.borderGrey}
              onChangeText={text => {
        ...
        />
 {
      ...
      <TextInput
        ...
        />
          ...
          <Text style={[styles.appliedText,{fontSize:normalize(15)}]}>Recipient’s Details ( Below Fields For Display Only ) </Text>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.labelText}>Allow clubing with other purchased items</Text>
          </TouchableOpacity>
