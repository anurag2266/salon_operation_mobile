...
const ManageSalonPhotos = ({navigation}) => {
  ...
  return (
    <>
      <Container
        ...
        description={
          ' These images will be visible on your Salonesis business profile for the clients'
        }
        onPressBottomButton={handleSubmitImages}>
        <View style={styles.container}>
          <View style={styles.buttonContainer}>
            <Text style={styles.buttonTitle}>Salon Indoor Images</Text>
          </View>
          ...
          <View style={{alignItems: 'center'}}>
            <FlatList
              ...
              numColumns={2}
              data={[...salonDetails.indoorImages, ...indoorImages]}
            ...
            <TouchableOpacity
              ...
              style={{marginHorizontal: vw(21), alignSelf: 'flex-start'}}>
          ...
          <View style={styles.buttonContainer}>
            <Text style={styles.buttonTitle}>Salon Outdoor Images</Text>
          </View>
          <View style={{alignItems: 'center'}}>
            <FlatList
              contentContainerStyle={{marginTop: vh(10)}}
              numColumns={2}
              data={[...salonDetails.outdoorImages, ...outdoorImages]}
              renderItem={({item, index}) => (
                <Image
                  style={{
                    width: vw(180),
...
export default ManageSalonPhotos;
