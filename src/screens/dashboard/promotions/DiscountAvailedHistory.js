...
const DiscountAvailedHistory = ({navigation}) => {
  ...
  return (
    <Container
      title={'Discount Availed History'}
      ...
      <Text style={styles.availedDetailText}>Discount Availed Details</Text>
...
export default DiscountAvailedHistory