...
const ComboOfferAvailedHistory = ({navigation}) => {
  ...
  return (
    <Container
      title={'Combo Offer Availed History'}
      ...
      <Text style={styles.availedDetailText}>Combo Offers Availed Details</Text>
      ...
      <View style={{ marginTop:vh(20),backgroundColor:"#D2D2D2"}}>
        
        <Text style={{margin:vh(20),fontSize:normalize(20),color:theme.color.primary,fontFamily:theme.font.bold}}>Services</Text>
...
<View style={{ marginTop:vh(20),backgroundColor:"#D2D2D2"}}>
        ...
        <Text style={{margin:vh(20),fontSize:normalize(20),color:theme.color.primary,fontFamily:theme.font.bold}}>Products</Text>
...
export default ComboOfferAvailedHistory